[index.html](https://github.com/user-attachments/files/31051288/index.html)
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      header .grid { width: 100% !important; }
      header .grid > div { padding: 10px 8px !important; min-width: 0; }
      header .grid .text-xl { font-size: 1.05rem !important; }
      ...
      #app p, #app button { font-size: 1rem !important; }
      #app .text-5xl { font-size: 2.5rem !important; }
      #app .text-6xl, #app .text-7xl, #app .text-8xl { font-size: 3.25rem !important; }
      #app .glass.rounded-2xl, #app .glass.rounded-3xl { border-radius: 18px !important; }
      #choices button, #app button { min-height: 50px; }
      #choices button { padding: 14px !important; }
      footer { padding: 0 10px; line-height: 1.4; }
    }

    @media (max-width: 480px) {
      header .grid.grid-cols-2.sm\:grid-cols-4 { grid-template-columns: 1fr 1fr !important; }
      #app { padding: 16px 12px !important; }
      #app .mt-6.flex.flex-col.sm\:flex-row { align-items: stretch !important; }
      #app .mt-6.flex.flex-col.sm\:flex-row > * { width: 100% !important; }
      #app .max-w-2xl, #app .max-w-3xl, #app .max-w-4xl { max-width: 100% !important; }
      #app .p-5, #app .p-6 { padding: 14px !important; }
      #app .mt-8 { margin-top: 1.25rem !important; }
      #app .mb-6 { margin-bottom: 1rem !important; }
    }

    @media (orientation: landscape) and (max-height: 600px) {
      header.glass { padding: 12px 16px !important; }
      #app { padding-top: 14px !important; padding-bottom: 14px !important; }
      #app .text-7xl, #app .text-8xl { font-size: 2.6rem !important; }
    }
...
function renderIntro(){
  document.getElementById("app").innerHTML = `
    <section class="max-w-3xl mx-auto text-center py-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 mt-8 text-sm">
      ...
      <button onclick="startGame()" class="mt-8 w-full sm:w-auto bg-cyan-300 text-slate-950 font-black px-7 py-4 rounded-2xl hover:scale-105 transition">
  ...
  document.getElementById("app").innerHTML = `
    <section class="max-w-4xl mx-auto fade-in">
      <div class="flex flex-col sm:flex-row sm:items-start gap-4 mb-6">
        <div class="text-4xl sm:text-5xl bg-white/10 rounded-2xl p-3 sm:p-4 shrink-0">${r.icon}</div>
        <div>
...
function renderFinal(){
  ...
  document.getElementById("app").innerHTML=`
    <section class="max-w-4xl mx-auto text-center py-7 fade-in">
      ...
      <button onclick="resetGame()" class="mt-7 w-full sm:w-auto bg-cyan-300 text-slate-950 font-black px-6 py-3 rounded-2xl">Jugar nuevamente</button>
    </section>`;
  updateHUD();
}
...
function renderTimeOut(){
  document.getElementById("app").innerHTML=`
    <section class="max-w-2xl mx-auto text-center py-12">
      ...
      <button onclick="resetGame()" class="mt-7 w-full sm:w-auto bg-yellow-300 text-slate-950 font-black px-6 py-3 rounded-2xl">Reiniciar misión</button>
    </section>`;
}
